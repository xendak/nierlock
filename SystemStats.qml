    ...
    FileView {
        ...
        onLoaded: {
            ...
            if (data) {
                ...
                root.lastCpuTotal = total.toFixed(1);
                root.lastCpuIdle = idle.toFixed(1);
            }
        }
    }
    ...
    Process {
        ...
        stdout: SplitParser {
            onRead: data => {
                ...
                root.cpuTemp = (sum / temps.length / 1000).toFixed(1);
            }
        }
    }
    ...
    Process {
        ...
        stdout: SplitParser {
            ...
            onRead: data => {
                ...
                root.gpuPerc = (sum / percs.length / 100).toFixed(1);
            }
        }
    }
